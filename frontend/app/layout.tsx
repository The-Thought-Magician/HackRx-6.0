...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Insurance RAG System - Intelligent Document Processing</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        {/* <!--  Social tags   --> */}
        <meta
          name="keywords"
          content="insurance, document processing, RAG, AI, machine learning"
        />
        <meta name="description" content="Intelligent insurance document processing and query system using RAG technology" />
